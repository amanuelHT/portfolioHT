...
export default function ExtraProjects() {
  return (
     <section id="education" className="education-timeline px-16 py- max-w-4xl mx-auto">
      <h2 className="text-1xl font-bold mb-4">Extra Projects</h2>
      <div className="grid grid-cols-4 sm:grid-cols-3 md:grid-cols-4 gap-4 border p-2 rounded-lg bg-white shadow-sm">
      ...
      <div className="mt-4 text-sm text-blue-600 underline underline-offset-2 pl-3 border-l-2 border-dashed border-gray-400">
        <a href="https://github.com/amanuelHT" target="_blank" rel="noopener noreferrer">
          More on GitHub ↗
        </a>
      </div>
    </section>
